...
class ProveSuccessScreen extends StatefulWidget {
  const ProveSuccessScreen({super.key});

  @override
  State<ProveSuccessScreen> createState() => _ProveSuccessScreenState();
}

class _ProveSuccessScreenState extends State<ProveSuccessScreen> {
